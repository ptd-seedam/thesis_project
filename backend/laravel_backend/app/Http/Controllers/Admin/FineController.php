...
class FineController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.fines.create', compact('users', 'borrowings'));
    }
    ...
    public function store(FineRequest $request)
    {
        ...
        return redirect()->route('admin.fines.index')->with('success', 'Tạo khoản phạt thành công');
    }
    ...
    public function edit($id)
    {
        ...
        $users = $this->fineService->getAllUsers();
        $borrowings = $this->fineService->getAllBorrowings();
        return view('admin.fines.edit', compact('fine', 'users', 'borrowings'));
    }
    ...
    public function update(FineRequest $request, $id)
    {
        ...
        return redirect()->route('admin.fines.index')->with('success', 'Cập nhật khoản phạt thành công');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.fines.index')->with('success', 'Xóa khoản phạt thành công');
    }
}
