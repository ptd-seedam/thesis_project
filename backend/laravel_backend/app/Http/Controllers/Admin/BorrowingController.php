...
class BorrowingController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($users->isEmpty() || $books->isEmpty()) {
            return redirect()->route('admin.borrowings.index')->with('error', 'Không có người dùng hoặc sách nào để mượn');
        }
    ...
    public function store(BorrowingRequest $request)
    {
        ...
        if ($this->bookService->decreaseBookStatus($data['B_ID'])) {
            ...
            return redirect()->route('admin.borrowings.index')->with('success', 'Tạo lượt mượn thành công');
        } else {
    ...
    public function update(BorrowingRequest $request, $id)
    {
        ...
        return redirect()->route('admin.borrowings.index')->with('success', 'Cập nhật lượt mượn thành công');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.borrowings.index')->with('success', 'Xóa lượt mượn thành công');
    }
}
