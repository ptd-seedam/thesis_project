                        ...
                        <tbody>
                            @foreach ($fines as $fine)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('librarian.fines.edit', $fine->F_ID) }}" class="btn btn-sm btn-primary">Sửa</a>
                                        <form action="{{ route('librarian.fines.destroy', $fine->F_ID) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
